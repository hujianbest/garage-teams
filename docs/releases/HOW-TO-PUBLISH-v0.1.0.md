...
Reference SHAs (from a clean build of this rename branch, `uv sync` + `uv run python -m build` on WSL Ubuntu 24.04 / Python 3.12):

| File | Size | SHA-256 |
|---|---|---|
| `garage_agent-0.1.0-py3-none-any.whl` | ~189 KB | `06072442c11e8354fb969dc7106e6d22b8429718ff9669dde59a01bcb38ffb3f` |
| `garage_agent-0.1.0.tar.gz` | ~199 KB | `7e14d6440033f528334ae6972025ef2c4af253afae640c6bd0b7bba8cb4de891` |

> **Why these SHAs are different from the pre-rename ones (`ee001cf3...` / `e7f4bb3f...` from PR #51):**
