# Garage Extensible Layered Architecture
...
1. 先拆 `Garage Core`
   - 当前拆解文档见 `docs/garage/garage-core-subsystems-architecture.md`
   - 其中包括 `Session`、`Registry`、`Governance`、`Artifact Routing`、`Evidence`
2. 再拆 `Shared Contracts`
   - 当前拆解文档见 `docs/garage/garage-shared-contracts.md`
...
3. 再拆 continuity layers
   - 当前拆解文档见 `docs/garage/garage-continuity-memory-skill-architecture.md`
   - 其中包括 `memory`、`session`、`skill`、`evidence` 的持续性分层
4. 再拆 phase 1 的 reference packs
   - 当前拆解文档见 `docs/garage/garage-phase1-reference-packs.md`
