...
| design doc | `docs/designs/YYYY-MM-DD-<topic>-design.md` | 说明怎么做 |
...
- design doc: docs/architecture/designs/
...
- app:web design doc: apps/web/docs/designs/
