...
3. `docs/GARAGE.md`
4. `docs/ROADMAP.md`
5. `docs/architecture/1-garage-system-overview.md`
6. `docs/architecture/2-garage-runtime-reference-model.md`
7. `docs/features/F10-agent-teams-product-surface.md`
8. `docs/features/F11-runtime-topology-and-entry-bootstrap.md`
