...
**与 step 4 (Profile) 的关系**: advisory 是历史经验摘要, 不影响 Profile 选择本身. step 4 仍按项目级强制规则 → 沿用已有 profile → 按证据选择. advisory 中如果显示历史路径耗时 / 常见 lessons, router 可在 handoff 块内一同传递供下游参考, 但不替代 evidence-based decision.
