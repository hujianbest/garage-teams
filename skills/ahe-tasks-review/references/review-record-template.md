...
{
  "conclusion": "需修改",
  "next_action_or_recommended_skill": "ahe-tasks",
...
| `需修改` | `ahe-tasks` | false | false |
| `阻塞`（内容回修） | `ahe-tasks` | false | false |
| `阻塞`（route/stage冲突） | `ahe-workflow-router` | false | true |
