...
`skills/` 是当前仓库里 AHE coding workflow family 的来源技能面，承接 skill、共享文档、模板与设计规则。
...
- `skills/docs/`：AHE coding workflow 的共享文档
- `skills/templates/`：AHE coding workflow 的共享模板
...
- 新会话入口、命令入口或 family discovery，先读 `skills/using-ahe-workflow/SKILL.md`
- 需要 authoritative runtime routing 或恢复编排时，读 `skills/ahe-workflow-router/SKILL.md`
- 需要共享规则时，读 `skills/docs/`
- 需要模板时，读 `skills/templates/`
...
- `skills/docs/ahe-worktree-isolation.md`
...
2. 每个 skill 入口统一放在 `skills/<skill-name>/SKILL.md`。
