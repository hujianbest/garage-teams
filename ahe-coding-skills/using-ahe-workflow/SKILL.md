...
- `ahe-coding-skills/docs/ahe-command-entrypoints.md`
- `ahe-coding-skills/docs/ahe-workflow-shared-conventions.md`
- `ahe-coding-skills/ahe-workflow-router/SKILL.md`

读取规则：

- 需要理解 public entry 与 direct invoke 边界时，先看 `ahe-coding-skills/docs/ahe-workflow-entrypoints.md`
- 需要解释 `/ahe-*` 命令时，读 `ahe-coding-skills/docs/ahe-command-entrypoints.md`
- 需要 authoritative runtime routing 时，进入 `ahe-coding-skills/ahe-workflow-router/SKILL.md`
