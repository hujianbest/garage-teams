...
2. 选择当前唯一活动任务
3. 先设计测试用例并与真人对话确认
4. 再按 TDD 执行 Red -> Green -> Refactor
5. 产出或更新 UT/集成测试
6. 进入 `mdc-bug-patterns`、`mdc-test-review`、`mdc-code-review`
7. 执行 `mdc-traceability-review`
7. 运行回归检查与完成验证
