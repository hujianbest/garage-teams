# OpenXML SDK 3.x 完整参考百科全书

**目标：** DocumentFormat.OpenXml 3.x / .NET 8+ / C# 12
**最后更新：** 2026-03-22

本文档可作为使用 OpenXML SDK 构建 DOCX 文件的详尽参考。每个代码块都准备好复制粘贴。
...
1. [文档创建骨架](#1-文档创建骨架)
2. [风格系统深度探究](#2-style-system-deep-dive)
3. [字符格式化（RunProperties）]（#3-character-formatting-runproperties--详尽）
4. [段落格式（ParagraphProperties）]（#4-paragraph-formatting-paragraphproperties--详尽）

---

## 1. 文档创建骨架

### 1.1 完整流程：创建到保存```csharp
// =============================================================================
...
```### 1.3 基于流的创建（MemoryStream for Web）```csharp
// =============================================================================
...
```### 2.2 DocDefaults 和文档范围的默认值```csharp
// =============================================================================
...
## 3. 字符格式（RunProperties）——详尽```csharp
// =============================================================================
...
## 4. 段落格式（ParagraphProperties）——详尽```csharp
// =============================================================================
...
## 附录 B：OpenXmlUnits 帮助程序类```csharp
// =============================================================================
